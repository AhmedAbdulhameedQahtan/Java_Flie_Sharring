...
//        while (FlieSharringServer.socket.isConnected()) {
//            try {
//                if (!dis.readBoolean()) {
//                    String text = dis.readUTF();
//                    FlieSharringServer.broadcast(text);
//                } else {
//                    Docs(dis, dos);
//                }
//            } catch (IOException e) {
        ...
        try {
            ...
            if (fileNameLength > 0) {
                ...
                if (fileContentLength > 0) {
                    ...
                    FlieSharringServer.broadcastFile(fileNameLength, fileNameBytes, fileContentLength, fileContentBytes);
                }
